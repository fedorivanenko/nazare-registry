...
INSTALL_REF=${NAZARE_INSTALL_REF:-refs/heads/main}
INSTALL_SCRIPT_URL=${NAZARE_INSTALL_SCRIPT_URL:-"https://raw.githubusercontent.com/fedorivanenko/nazare/$INSTALL_REF/install.sh"}
CLI_URL=${NAZARE_CLI_URL:-"https://raw.githubusercontent.com/fedorivanenko/nazare/$INSTALL_REF/packages/nazare/bin/nazare.js"}
PACKAGE_URL=${NAZARE_PACKAGE_URL:-"https://raw.githubusercontent.com/fedorivanenko/nazare/$INSTALL_REF/packages/nazare/package.json"}
